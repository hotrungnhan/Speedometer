package com.hotrungnhan.speedometer.customs;
...
public class DonutProgress extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        innerBottomTextSize = textView.getTextSize();
        innerBottomTextColor = attributes.getColor(R.styleable.DonutProgress_donut_inner_bottom_text_color, default_inner_bottom_text_color);
        innerBottomText = attributes.getString(R.styleable.DonutProgress_donut_inner_bottom_text);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        innerBottomTextHeight = getHeight() - (getHeight() * 3) / 4f;
    }
    ...
    private int getColorBasedOnPercentage(Double percentage) {
        ...
        int startColor = ContextCompat.getColor(getContext(), R.color.negativeColor);
        int endColor = ContextCompat.getColor(getContext(), R.color.positiveColor);
        return ColorUtils.blendARGB(startColor, endColor, percentage.floatValue());
    }
}