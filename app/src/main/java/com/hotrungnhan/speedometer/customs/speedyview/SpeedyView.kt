package com.hotrungnhan.speedometer.customs.speedyview
...
class SpeedyView @JvmOverloads constructor(
    context: Context,
    ...
    private val digitalFontTypeFace =
        Typeface.createFromAsset(getContext().assets, "fonts/digital.ttf")
    ...
    private val paintSpeed = Paint().apply {
        ...
        style = Paint.Style.FILL
        color = textColor
        textSize = mainTextView.textSize * 2
